        ...
        <div class="col-md-12">
            <div class="card card-teal shadow-lg">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-edit mr-2"></i> Edit Data Obat</h3>
                </div>

                <div class="card-body p-4">
                    <?= form_open('obat/updatedata/'.$obat['idobat'], ['id' => 'formeditobat']) ?>
                    <?= csrf_field() ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="idobat" name="idobat" value="<?= $obat['idobat'] ?>" readonly>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama" name="nama" value="<?= $obat['nama'] ?>" placeholder="Masukkan nama obat">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="stok" name="stok" value="<?= $obat['stok'] ?>" placeholder="Jumlah stok obat">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="keterangan" name="keterangan" rows="4" placeholder="Keterangan tambahan (opsional)"><?= $obat['keterangan'] ?></textarea>
...
<script>
$(function() {
    $('#formeditobat').submit(function(e) {
        e.preventDefault();
