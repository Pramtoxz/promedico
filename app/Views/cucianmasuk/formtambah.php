...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card card-navy">
            ...
            <div class="card-body">
                <?= form_open('/cucianmasuk/save', ['id' => 'formcucianmasuk', 'enctype' => 'multipart/form-data']) ?>
                <?= csrf_field() ?>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="nofak">Nomor Faktur</label>
                            <input type="text" id="nofak" name="nofak" class="form-control" value="<?= $nofak ?>"
                                readonly>
...
<script>
$(function() {
    $('#formcucianmasuk').submit(function(e) {
        e.preventDefault();
                ...
                if (response.sukses) {
                    ...
                    setTimeout(function() {
                        window.location.href =
                            '<?= site_url('/cucianmasuk/detail/' . $nofak) ?>';
                    }, 1500);
                }
            },
