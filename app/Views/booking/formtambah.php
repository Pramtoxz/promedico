        ...
        <div class="col-md-12">
            <div class="card card-teal shadow-lg">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-calendar-alt mr-2"></i> Tambah Booking</h3>
                </div>

                <div class="card-body p-4">
                    <?= form_open('booking/save', ['id' => 'formtambahbooking']) ?>
                    <?= csrf_field() ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="idbooking" name="idbooking" value="<?= $next_number ?>" readonly class="form-control">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="namapasien" name="namapasien" class="form-control" readonly placeholder="Pilih Pasien">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="hidden" id="idjadwal" name="idjadwal" class="form-control" readonly>
                                        <input type="text" id="infojadwal" name="infojadwal" class="form-control" readonly placeholder="Pilih Jadwal">
                                        <div class="input-group-append">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="tanggal" name="tanggal" class="form-control" min="<?= date('Y-m-d') ?>" disabled>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="time" id="waktu_mulai" name="waktu_mulai" class="form-control" readonly>
...
$(function() {
    ...
    $('#formtambahbooking').submit(function(e) {
        e.preventDefault();
