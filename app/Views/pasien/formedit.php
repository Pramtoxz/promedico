...
<div class="row">
    <div class="col-md-8">
        <div class="card card-teal">
            ...
            <div class="card-body">
                <?= form_open('pasien/updatedata/'.$pasien['id_pasien'], ['id' => 'formeditpasien', 'enctype' => 'multipart/form-data']) ?>
                <?= csrf_field() ?>
                <div class="row">
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="nama" name="nama" class="form-control" value="<?= $pasien['nama'] ?>">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="nohp" name="nohp" class="form-control" value="<?= $pasien['nohp'] ?>">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="tgllahir" name="tgllahir" class="form-control" value="<?= $pasien['tgllahir'] ?>">
                ...
                <?php if(!empty($pasien['iduser'])): ?>
                <hr>
                <div class="row">
                    <div class="col-sm-12">
                        <h5><i class="fas fa-user-shield"></i> Informasi Akun User</h5>
                        <p class="text-muted">Pasien ini sudah memiliki akun user. Anda dapat mengubah password jika diperlukan.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control" value="<?= $user['email'] ?? '' ?>" <?= !empty($user) ? 'readonly' : '' ?>>
