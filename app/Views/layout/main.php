...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php base_url() ?>/assets/vendor/libs/node-waves/node-waves.css" />
  ...
  <body>
              ...
              <div class="row gy-6">
                ...
                <div class="col-md-12 col-lg-4">
                  <div class="card">
                    ...
                    <img
                      src="<?php base_url() ?>/assets/img/illustrations/trophy.png"
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                            <img src="<?php base_url() ?>/assets/img/icons/misc/zipcar.png" alt="zipcar" />
                          </div>
                        ...
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                            <img src="<?php base_url() ?>/assets/img/icons/misc/bitbank.png" alt="bitbank" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex">
                          <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                            <img src="<?php base_url() ?>/assets/img/icons/misc/aviato.png" alt="aviato" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                          ...
                          <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/payments/gumroad.png"
                                  class="img-fluid"
                                  alt="gumroad"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/payments/mastercard-2.png"
                                  class="img-fluid"
                                  alt="mastercard"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/payments/stripes.png"
                                  class="img-fluid"
                                  alt="stripes"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/payments/american-bank.png"
                                  class="img-fluid"
                                  alt="american"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex align-items-center">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/payments/citi.png"
                                  class="img-fluid"
                                  alt="citi"
                                  height="30"
                                  width="30" />
                        ...
                        <div class="withdraw-content pt-2">
                          <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/brands/google.png"
                                  class="img-fluid"
                                  alt="google"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/brands/github.png"
                                  class="img-fluid"
                                  alt="github"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/brands/slack.png"
                                  class="img-fluid"
                                  alt="slack"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/payments/digital-ocean.png"
                                  class="img-fluid"
                                  alt="digital"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex align-items-center">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="<?php base_url() ?>/assets/img/icons/brands/aws.png"
                                  class="img-fluid"
                                  alt="aws"
                                  height="30"
                                  width="30" />
                        ...
                        <tbody>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="<?php base_url() ?>/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="<?php base_url() ?>/assets/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="<?php base_url() ?>/assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="<?php base_url() ?>/assets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="<?php base_url() ?>/assets/img/avatars/4.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="<?php base_url() ?>/assets/img/avatars/7.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="<?php base_url() ?>/assets/img/avatars/6.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
    ...
    <script src="<?php base_url() ?>/assets/vendor/libs/node-waves/node-waves.js"></script>
