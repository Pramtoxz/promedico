        ...
        <div class="col-md-12">
            <div class="card card-teal shadow-lg">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-edit mr-2"></i> Edit Jenis Perawatan</h3>
                </div>

                <div class="card-body p-4">
                    <?= form_open('jenis/updatedata/'.$jenis['idjenis'], ['id' => 'formeditjenis']) ?>
                    <?= csrf_field() ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="idjenis" name="idjenis" value="<?= $jenis['idjenis'] ?>" readonly>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="namajenis" name="namajenis" value="<?= $jenis['namajenis'] ?>" placeholder="Masukkan nama jenis perawatan">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="estimasi" name="estimasi" value="<?= $jenis['estimasi'] ?>" placeholder="Estimasi waktu pengerjaan (dalam menit)">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="harga" name="harga" value="<?= $jenis['harga'] ?>" placeholder="Masukkan harga jasa">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="keterangan" name="keterangan" rows="4" placeholder="Keterangan tambahan (opsional)"><?= $jenis['keterangan'] ?></textarea>
