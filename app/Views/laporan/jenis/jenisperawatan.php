...
<div class="col-md-12">
    <div class="card card-teal">
        <div class="card-header">
            <h3 class="card-title">Laporan Jenis Perawatan</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <div class="row-sm-12" id="printHalaman">
                <div class="d-flex justify-content-center align-items-center text-center">
                    ...
                    <div>
                        ...
                        <b style="font-size: 20px; font-family: 'Times New Roman'; margin-bottom: 0; text-decoration: underline;">Laporan Jenis Perawatan</b>
                    </div>
                </div>
                <div class="tabelAset">
                </div>
...
<script>
    function ViewLaporanSemua() {
        $.ajax({
            type: "get",
            url: "<?= base_url('laporan-jenis/view') ?>",
            dataType: "JSON",
